...
export default function InterfazUsuario() {
  ...
  const handleRunSystem = async () => {
    ...
    try {
      ...
      if (algoritmoRecomendado === "Programación Dinámica") {
        resultadoAlgoritmo = solveDynamicProgramming(items, W);
      } else if (algoritmoRecomendado === "Greedy") {
        resultadoAlgoritmo = solveGreedy(items, W);
      } else if (algoritmoRecomendado === "Backtracking") {
      ...
      setMetrics({
        tiempoIA: aiResponse.tiempoEstimado,
  ...
  return (
    <div style={styles.appContainer}>
      ...
      <div style={styles.workspaceGrid}>
        ...
        {/* COLUMNA IZQUIERDA: Configuración y Datos de Entrada */}
        ...
        {/* COLUMNA DERECHA: Inteligencia y Resultados Analíticos */}
